      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 backdrop-blur-sm shadow-lg shadow-primary/50 group-hover:shadow-primary/80 transition-all duration-300 group-hover:scale-110">
              <span className="text-primary font-extrabold text-xl">F1</span>
            </div>
            <span className="text-xl font-extrabold tracking-tight hidden sm:block text-gray-900">
              Dashboard
            </span>
          </Link>
